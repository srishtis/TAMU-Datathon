...
if __name__ == "__main__":
    ...
    # model training
    history = model.fit(train_data.shuffle(num_samples).batch(512), epochs=50, validation_data=validation_data.batch(512), verbose=1)
    ...
    model.save('text_product_classify_7_cat')
